...
For Each ws In Worksheets
    ...
    For i = 2 To LastRow
        ...
        If ws.Cells(i + 1, 1) <> ws.Cells(i, 1) Then
            ...
            Yearly_Change = fecha - apertura
            
            
            If apertura = 0 Then
                Percent_Change = 0
            Else
                Percent_Change = Yearly_Change / apertura * 100
           End If
